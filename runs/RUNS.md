...
| [run-004](run-004.md) | 2026-06-11 | **C1 PASS / C2 PASS** | 0.60 | 0.50 / 0.50 | −0.10 / −0.10 | 4.4 | 4.4 / 4.4 | 0.00 / 0.00 | 2/2 chunks. Validates chunk naming + purge fix. Loss improved C1→C2 (1.337→1.262). |
