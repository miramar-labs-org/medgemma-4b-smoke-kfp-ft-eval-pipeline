...
| [run-004](run-004.md) | 2026-06-11 | **C1 PASS** | 0.60 | 0.50 | −0.10 | 4.4 | 4.4 | 0.00 | Chunk 1/2 complete. Validates chunk-qualified run naming (run-004-1/2) in KFP + MLflow. Purge fix validated. |
